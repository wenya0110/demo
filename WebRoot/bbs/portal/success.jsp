...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link type="text/css" rel="stylesheet" href="<%=basePath %>bbs/css/base.css" />
   <link rel="stylesheet" type="text/css" href="<%=basePath %>bbs/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="<%=basePath %>bbs/css/purchase.sop.css" />
   ...
   <script type="text/javascript" src="<%=basePath %>bbs/js/base-2011.js" charset="utf-8"></script>
   <script type="text/javascript" src="<%=basePath %>bbs/js/jquery.cookie.js" charset="utf-8"></script>
</head> 
<body id="mainframe">
<!--shortcut start-->
		...
		<div class="mc" id="success_detail">	
		    <ul class="list-order">
			    <li class="li-st">
					...
					<!-- 货到付款 -->
					<div class="fore2">${paymentway }:<strong class="ftx-01">${price}元</strong></div>
					<div class="fore3">
