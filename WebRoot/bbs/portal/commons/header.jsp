...
%>
<script type="text/javascript" src="<%=basePath %>bbs/js/base-v1.js" charset="utf-8"></script>
...
$(function(){
    ...
    //alert(userid);
    //用户登录了,发送了ajax请求
    $.post("<%=basePath%>cart/getcount",{buyerid:userid},function(data){
...
var userid = "${userid}";
if(userid != null && userid != undefined && "" != userid){
//已经登录，发请求cart/getcarts
window.location.href="<%=basePath%>cart/getcarts";
}else{
//让用户登录
alert(window.location.href);
window.location.href="<%=basePath%>login/login/login.jsp?returnurl="+window.location.href;
}
}
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true">
			<b></b>
			<img src="<%=basePath %>bbs/images/XBB2.png" width="270" height="60" alt="新巴巴"></a>
		</div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="settleup-2013">
			<dl>
				<dt class="ld">
					...
					<a href="javascript:;"  id="settleup-url" onclick="gotocart()">去购物车结算</a>
				</dt>
<!-- 				<dd>
					<div class="prompt">
				...
				<div id="_JD_ALLSORT" class="mc">
					<div class="item fore1">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/1.html">图书、音像、电子书刊</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore2">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/74.html">家用电器</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore3">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/161.html">电脑、办公</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore4">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/249.html">个护化妆</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore5">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/290.html">钟表</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore6">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/296.html">母婴</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore7">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/378.html">食品饮料、保健食品</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore8">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/438.html">汽车用品</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore9">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/495.html">玩具乐器</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore10">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/558.html">手机</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore11">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/580.html">数码</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore12">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/633.html">家居家装</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore13">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/699.html">厨具</a>
							</h3>
							<s></s></span>
					</div>
					<div class="item fore14">
						<span data-split="1"><h3>
								<a href="<%=basePath %>bbs/products/749.html">服饰内衣</a>
							</h3>
							<s></s></span>
					</div>
					<div class="extra">
