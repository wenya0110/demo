...
String s = request.getParameter("returnurl");
if(s==null || "".equals(s)){
s = basePath+"bbs/portal/index.jsp";
}
...
<link rel="stylesheet" type="text/css" href="<%=basePath %>login/css/base.css" media="all" />
<link type="text/css" rel="stylesheet" href="<%=basePath %>login/css/a.css" source="widget" />
<script type="text/javascript" src="<%=basePath %>login/css/jquery-1.js"></script >
...
<body>
	...
	<div class="w">
		<div id="logo">
			<a href="javascript:;"> <img src="<%=basePath %>login/images/XBB2.png" alt="新巴巴"
						...
						<div class="mc">
							...
							<div class="qrcode-main">
								<div class="qrcode-img">
									<img src="<%=basePath %>login/css/blank.gif" alt="" /><div
