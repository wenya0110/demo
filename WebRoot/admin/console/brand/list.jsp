...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<c:forEach items="${list }" var ="b">
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center"><img width="40" height="40" src="<%=basePath %>bbs${b.imgUrl}"/></td>
			<td align="center">${b.description }</td>
			<td align="center">${b.sort }</td>
			<td align="center"><c:if test="${b.isDisplay==true }">是</c:if><c:if test="${b.isDisplay!=true }">否</c:if> </td>
			<td align="center">
			<a class="pn-opt" href="<%=basePath%>adminbrand/getbyid?id=${b.id}">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="#">删除</a>
			</td>
		</tr>
